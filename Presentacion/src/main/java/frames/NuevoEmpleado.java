...
import administrarEmpleado.FacadeAdministrarEmpleado;
...
public class NuevoEmpleado extends javax.swing.JFrame {
    ...
    public NuevoEmpleado() {
        ...
        lblNuevoEmpleado.setIcon(new javax.swing.ImageIcon("C:\\Users\\Genesis\\Desktop\\VentaAutomoviles\\src\\recursos\\iconoEmpleados.png"));
    ...
    private void btnRegistrarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarEmpleadoActionPerformed
        ...
        if (validacion()) {
            ...
            //Registro TEMPORAL
            JOptionPane.showMessageDialog(NuevoEmpleado.this, 
            "El empleado ha sido registrado.", "Exito!", JOptionPane.INFORMATION_MESSAGE);
    ...
    private boolean validacion() {
        ...
        if (!txtUsuario.getText().trim().isEmpty() && !txtContraseña.getText().trim().isEmpty() && 
            ...
            !txtCurp.getText().trim().isEmpty() && !txtCorreo.getText().trim().isEmpty()){   
         return true;
        }return false;
    }
